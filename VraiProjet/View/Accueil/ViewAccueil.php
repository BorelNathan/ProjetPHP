...
<?php if($UtilisateurCourantIDRole == 0){ ?>
		<section class="connection" id="notConnected">
				...
				<ul>
						...
						<li><a class="roundCornerLink" href='#' onclick='document.getElementById("signup").submit()' />s'inscrire</a></li>
				</ul>
		</section>
    <?php }
    else{ ?>
			<section class="connection" id="connected">
					<ul>
							...
							<li><a class="roundCornerLink" href="logout.php" id="logoutli"><img id="logout" src="../../resources/images/logout.svg" alt="se déconnecter" /></a></li>
					</ul>
			</section>
<?php } ?>
		</header>
