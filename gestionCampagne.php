...
<?php
    ...
    Nom de la campagne : <?php echo $_SESSION['CampagneChoisie'][7] . '</br>';?>
    Description de la campagne : <?php echo $_SESSION['CampagneChoisie'][6] . '</br>';?>
    Points minimum pour qu'un événement soit remarqué : <?php echo ['CampagneChoisie'][4] . '</br>';?>
    Points attribués aux donateurs (non modifiables après le début de la campagne) : <?php echo ['CampagneChoisie'][3] . '</br>';?>
    Date de début (année-mois-jour) : <?php echo $_SESSION['CampagneChoisie'][1] . '</br>';?>
    Date de fin (année-mois-jour) : <?php echo $_SESSION['CampagneChoisie'][2] . '</br><br/>';?>
    ...
    <a href="choixGestionCampagne.php">Choisir une autre campagne à modifier</a><br/>
